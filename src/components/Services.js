  ...
  const formatDescription = (description) => {
    ...
    lines.forEach((line) => {
      if (line.includes("What it is:")) {
        // Remove the bullet point character from the text
        bulletPoints.whatItIs = line.replace("•", "").trim()
      } else if (line.includes("For:")) {
        bulletPoints.forWho = line.replace("•", "").trim()
      } else if (line.includes("Benefit:")) {
        bulletPoints.benefit = line.replace("•", "").trim()
      }
    })
      ...
      <div className="service-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="service-modal-text">
          ...
          <ul className="service-bullet-list">
            <li>{bulletPoints.whatItIs}</li>
            <li>{bulletPoints.forWho}</li>
            <li>{bulletPoints.benefit}</li>
          </ul>
        </div>
      </div>
    </div>
